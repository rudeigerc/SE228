...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="icon/data_celtic_knot.ico">
...
<%
    ...
    if ("true".equals(isLogin)) {
        ...
        _out.println("    <nav class=\"navbar navbar-inverse navbar-fixed-top\">\n" +
                ...
                "                    <li class=\"btn-group\">\n" +
                "                        <div class=\"btn-group\">\n" +
                "                            <button type=\"button\" class=\"btn btn-primary dropdown-toggle\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">"+ username +" <span class=\"caret\"></span></button>\n" +

                "                        <ul class=\"dropdown-menu\">\n" +
                "                            <li><a href=\"index.jsp\"><span class=\"glyphicon glyphicon-home\"></span> Home</a></li>\n" +
                "                            <li role=\"separator\" class=\"divider\"></li>\n" +
                "                            <li><a href=\"logout\"><span class=\"glyphicon glyphicon-warning-sign\"></span> Log out</a></li>\n" +
                "                        </ul>\n" +
                "                        </div>\n" +
                "                    </li>\n" +
                "                </ul>" +
